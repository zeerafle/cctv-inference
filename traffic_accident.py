...
# c=1
i=1
cap= cv2.VideoCapture(r'E:\Semester 7\Hackaton\Traffic Accident\Viral- Horrific Pedestrian accident caught on Camera - Cyberabad Traffic Police.mp4')
...
while i < 1300:
    ...
    cv2.putText(frame, predict_frame(resized_frame), (50, 50), font, 2, (255, 255, 255), 2)
